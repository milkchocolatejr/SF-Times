...
def draw_buttons():
    ...
    #print("comp", len(completed_buttons))
    #print("rem", remaining_buttons)
        ...
        if set(group_set) in setF:
            ...
            for x in setF:
                if len(set(group_set) & x) >= 3:
                    ...
                    print("Selected buttons are not from the same group.")
    else:
...
def shuffle_buttons():
    ...
    print("groups", remaining_groups)
    print("indicies", remaining_indices)
    print("comp", completed_buttons)
